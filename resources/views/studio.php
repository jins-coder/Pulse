...
<div class="container" style="max-width: 1300px;">
        ...
        <div style="display: flex; align-items: center; gap: 1rem;">
            ...
            <div>
                <h1 style="font-size: 1.5rem; font-weight: 800; display: flex; align-items: center; gap: 0.5rem;">
                    ...
                    <span class="badge" style="background: rgba(56, 189, 248, 0.15); color: var(--accent-cyan);">v<?= e($version) ?> • <?= e($codename) ?></span>
                </h1>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(360px, 1fr)); gap: 1.75rem;">
        ...
        <div class="card">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.5rem; background: rgba(0,0,0,0.25); padding: 0.75rem; border-radius: var(--radius-md); max-height: 240px; overflow-y: auto;">
        ...
        <div class="card">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.5rem; background: rgba(0,0,0,0.25); padding: 0.75rem; border-radius: var(--radius-md);">
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0.75rem; background: rgba(255,255,255,0.03); border-radius: 6px;">
                    <span style="font-size: 0.85rem; color: #a78bfa; font-weight: 600;">#[AiTool] checkInventory</span>
                    <span class="badge" style="font-size: 0.7rem;">PHP Method</span>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0.75rem; background: rgba(255,255,255,0.03); border-radius: 6px;">
                    <span style="font-size: 0.85rem; color: var(--accent-cyan); font-weight: 600;">Channel: chat.{room}</span>
                    <span class="badge" style="font-size: 0.7rem;">Authorized</span>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0.75rem; background: rgba(255,255,255,0.03); border-radius: 6px;">
                    <span style="font-size: 0.85rem; color: var(--accent-cyan); font-weight: 600;">Channel: orders.live</span>
